...
import bannerImageTwo from '../images/Sphere_Gif_2.gif'
    ...
    return (
      <div className="main__component__wrapper">
        <div className="ghost__wrapper"> {/* Only to add Header Banner Image */}
          <div className="banner__image" style={{backgroundImage: `url(${bannerImageTwo})` }}>
            <img src={textLogo} alt="" className="text__logo" />
          </div>
        </div>
        <div className="content__main-wrapper">
          ...
          <p>Hasta el momento tu website es respnsivo entre laptops y pantallas externas, pero no para dispositivos moviles (<strong>Tablets y Celulares</strong>), pero lo sera una vez que tengamos el design asi puedo trabajar en eso de una sola vez.</p><br />
        </div>
      </div>
    )
  }
